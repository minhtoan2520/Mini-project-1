...
-   Bạn cần xác định và phân cấp các lớp đối tượng?
    + Chia làm 5 lớp:
        ...
        - class QuanLySanPham: implements InterfaceQLSP, chứa các phương thức CRUD, tìm kiếm, hiển thị và lưu mảng
        - class App: là class main chứa vòng lặp MENU, gọi các phương thức của QuanLySanPham để thực thi
    + Và 1 interface:
        - InterfaceQLSP: định nghĩa các phương thức chung cho việc quản lý sản phẩm: hiển thị, CRUD, tìm kiếm
